...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/admin/nav_admin.js"></script>
	<!-- nav_common -->
                    ...
                    <div class="col-12 flex-column main-nav-container">
                        <ul class="nav flex-column text-center main-nav">
                            ...
                            <li class="nav-item pt-4 pb-4" id="click1" onclick="clickTab(this);">
                                <a class="nav-link active" href="${pageContext.request.contextPath}/admin/allList/1">
                            ...
                            <li class="nav-item pt-4 pb-4" id="click3" onclick="clickTab(this);">
                                <a class="nav-link" href="${pageContext.request.contextPath}/admin/readmeList/1">
                            ...
                            <li class="nav-item pt-4 pb-4" id="click4" onclick="clickTab(this);">
                                <a class="nav-link active" href="${pageContext.request.contextPath}/admin/noticeList/1">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="menu-images" id="iconclick4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item pt-4 pb-4" id="click5" onclick="clickTab(this);">
                                <a class="nav-link active" href="${pageContext.request.contextPath}/admin/qnaList/1">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="menu-images" id="iconclick5" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                        <path d="M5.25 6.033h1.32c0-.781.458-1.384 1.36-1.384.685 0 1.313.343 1.313 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.007.463h1.307v-.355c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.326 0-2.786.647-2.754 2.533zm1.562 5.516c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
                                      </svg>
                                </a>
                            </li>
                            <li class="nav-item pt-4 pb-4" id="click6" onclick="clickTab(this);">
                                <a class="nav-link active" href="${pageContext.request.contextPath}/admin/report_list/1">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="menu-images" id="iconclick6" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
