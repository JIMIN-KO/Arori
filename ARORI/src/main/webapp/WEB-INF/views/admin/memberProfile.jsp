  ...
  <path fill-rule="evenodd"
				...
				<tr>
					...
					<td><input type="text" class="form-control" value="${count}"
						...
						class="btn btn-primary btn-sm font-weight-bold mt-5">회원 클래스로
							이동</a>
				</tr>
				...
				<tr>
					<td colspan="2"><a
						...
						class="btn btn-primary btn-lg font-weight-bold"> 수정하기</a><input
						type="button" class="btn btn-primary btn-lg font-weight-bold"
						value="삭제하기" onclick="del(${allMemberDto.member_no})"> <a
						href="${pageContext.request.contextPath}/admin/allList/1"
