		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">${list.member_nick}</td>
					<td>${list.qna_title}</td>
	 				...
	 				<td align="center">
						...
						<a class="text-danger font-weight-bold ml-3" href="${pageContext.request.contextPath }/admin/qnaDeleteAdmin/${list.c_no}/${list.qna_no}">
