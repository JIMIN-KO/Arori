...
<form action="write" method="post">
	신고자아이디 <input type="text" name="report_member"
		placeholder="아이디를 입력해주세요"> <br>
	<br> 신고유형 <select name="report_type">
	...
	<br> 신고내용
	<textarea name="report_content" placeholder="신고사유를 입력해주세요"></textarea>
	<br>
	<br> 신고아이디 <input type="text" name="report_crimi"
		placeholder="신고할 아이디"> <br>
