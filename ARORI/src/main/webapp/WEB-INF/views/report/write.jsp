...
<form action="write" method="post" id="report">
	<table class="table table-hover">
		<h1 class="font-weight-bold mt-4">신고글 작성</h1>
		...
		<tbody>
			...
			<tr>
				...
				<td><textarea name="report_content" placeholder="신고사유를 입력해주세요"
			...
			<tr>
				...
				<td><input type="text" name="report_crimi" class="form-control"
					placeholder="신고할 아이디"></td>
			</tr>

			<tr>
				<td><input type="submit" value="신고접수" id="ok"> <a
					href="${pageContext.request.contextPath}"><input type="submit"
